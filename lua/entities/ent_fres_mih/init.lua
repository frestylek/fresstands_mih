...
function ENT:Initialize()
	...
	self:SetModel("models/player/fres_mih/mih.mdl")
...
timer.Simple( 0.01, function() if self != nil and self:IsValid() then
ParticleEffectAttach( "mih_aura" , 1 , self , 0 ) end end)
